...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    #t_4_1.titulo-segundo.color-acento-contenido
      h2 4.1 Clustering con Python
    
    p La agrupación de datos es un método de clasificación no supervisado, cuyo principal objetivo es buscar patrones ocultos en los datos y con esto crear grupos específicos llamados clústeres. Uno de los algoritmos más usados es el k-means o k-medias por su fácil implementación, se inicia escogiendo un valor de k que se refiere a la cantidad de clústeres y la inicialización aleatoria de centroides.

    p.fw-bold.mb-5 A continuación se realiza la aplicación del clustering en el ejemplo que se ha venido trabajando:
    ...
    .container-100.py-5(style="background: linear-gradient(180deg, rgba(213,213,255,1) 0%, rgba(168,221,255,1) 100%);")
      .d-flex.align-items-start.mb-4
        .id-circular.mb-2.mx-auto(style="background: linear-gradient(180deg, rgba(179,26,143,1) 0%, rgba(254,17,126,1) 100%);" data-aos="fade-right")
          span 1
        .col.ps-3
          p Lo primero que se debe hacer en Python es importar las librerías necesarias para ejecutar el algoritmo no supervisado con k-means. 
            br
            |Para tal fin se utiliza el siguiente comando
          .d-flex.pe-md-3.mb-3
            .tarjeta.px-4.py-4(style="background-color: #24135A;" data-aos="fade-right")
              p.mb-0.text-white from sklearn.cluster import KMeans
      
      .d-flex.align-items-start.mb-4
        .id-circular.mb-2.mx-auto(style="background: linear-gradient(180deg, rgba(179,26,143,1) 0%, rgba(254,17,126,1) 100%);" data-aos="fade-right")
          span 2
        .col.ps-3
          p Para hallar el valor óptimo de k se aplicará el método del codo, calculando el algoritmo de agrupación para diferentes valores de k. El punto en el que se observa un cambio brusco en los datos de las inercias se tomará como el valor de k, la línea forma algo similar a la de un brazo y su codo, el código fuente en k-means se muestra a continuación. El método del codo o método Elbow se construye calculando la inercia después de aplicar el método k-means a 1 , 2 , 3, …, N clústeres, siendo la inercia la suma de las distancias al cuadrado de cada objeto del clúster a su centroide.

          p El código a utilizar es el siguiente:
          .d-flex.pe-md-3.mb-3
            .tarjeta.px-4.py-4(style="background-color: #24135A;" data-aos="fade-right")
              p.mb-0.text-white inercia =[] # suma de cuadrados
                br
                |for i in range (1,20):
              p.mb-0.text-white.ps-3 algoritmo = KMeans (n_clusters = I, max_iter =300).fit(X_entrenamiento)
              p.text-white.ps-3 inercia.append(algoritmo.inertia_)
      ...
      .d-flex.align-items-start.mb-4
        ...
        .col.ps-3
          ...
          .d-flex.pe-md-3.mb-3
            .tarjeta.px-4.py-4(style="background-color: #24135A;" data-aos="fade-right")
              p.mb-0.text-white algoritmo = KMeans( n_clusters=3, init =‘k-means++’, max_iter=300, n_init =10)
      ...
      .d-flex.align-items-start.mb-4
        ...
        .col.ps-3
          ...
          .d-flex.pe-md-3.mb-3
            .tarjeta.px-4.py-4(style="background-color: #24135A;" data-aos="fade-right")
              p.mb-0.text-white algoritmo.fit(X_entrenamiento)
      ...
      .d-flex.align-items-start.mb-4
        ...
        .col.ps-3
          ...
          .d-flex.pe-md-3.mb-3
            .tarjeta.px-4.py-4(style="background-color: #24135A;" data-aos="fade-right")
              p.mb-0.text-white centroides, etiquetas = algoritmo.cluster_centers_, algoritmo.labels_
      ...
      .d-flex.align-items-start.mb-4
        ...
        .col.ps-3
          ...
          .d-flex.pe-md-3.mb-3
            .tarjeta.px-4.py-4(style="background-color: #24135A; max-width: 610px" data-aos="fade-right")
              p.mb-0.text-white plt.figure(figsize =[10,6])
                br
    ...
    .tarjeta.p-3.p-md-5(style="background-color: #EBECFF")
      LineaTiempoC.color-acento-contenido(text-small)
          ...
          .col-lg-8.pe-lg-4.order-2.order-lg-1
            ...
            .d-flex.pe-md-3.mb-3
              .tarjeta.px-4.py-2(style="background-color: #24135A;" data-aos="fade-left")
                p.mb-0.text-white from sklearn.decomposition import PCA import pandas as pd
        ...
        .col-lg-11.mx-auto.d-flex.flex-wrap(titulo="Paso 2")
          .col-lg-8.pe-lg-4.order-2.order-lg-1
            p Posteriormente, se crea un subconjunto de variables del dataset original sobre el cual se realizará el análisis de los componentes principales.
            .d-flex.pe-md-3.mb-3
              .tarjeta.px-4.py-2(style="background-color: #24135A;" data-aos="fade-left")
                p.mb-0.text-white X_datos_pinguinos = df_pinguinos[[‘bill_length_mm’, ‘bill_depth_mm’, ‘flipper_length_mm’, ‘body_mass_g’]] Y_datos_pinguinos = df_pinguinos[‘species’]
        ...
        .col-lg-11.mx-auto.d-flex.flex-wrap(titulo="Paso 3")
          .col-lg-8.pe-lg-4.order-2.order-lg-1
            p Debido a que los componentes principales capturan variaciones entre las variables existentes, la mejor práctica es estandarizar todas las variables antes de implementar PCA, así todas queden en la misma escala, por ejemplo, en este caso body_mass_g contiene números muy grandes comparados con las otras medidas.
            .d-flex.pe-md-3.mb-3
              .tarjeta.px-4.py-2(style="background-color: #24135A;" data-aos="fade-left")
                p.text-white pca = PCA(n_components = 2) componentes = pca.fit(X_datos_pinguinos).components_ x_pca = pca.transform(X_datos_pinguinos) componentes = pd.DataFrame(componentes).transpose()

                p.mb-0.text-white componentes.columns = [‘Comp1’, ‘Comp2’] componentes.index = X_datos_pinguinos.columns print(componentes)
            p Generando
            .d-flex.pe-md-3.mb-3
              .tarjeta.px-4.py-2(style="background-color: #24135A;" data-aos="fade-left")
        ...
        .col-lg-11.mx-auto.d-flex.flex-wrap(titulo="Paso 4")
          .col-lg-8.pe-lg-4.order-2.order-lg-1
            ...
            .d-flex.pe-md-3.mb-3
              .tarjeta.px-4.py-2(style="background-color: #24135A;" data-aos="fade-left")
                p.mb-0.text-white 0.999876*body_mass_g +0.015195*flipper_lengfth_mm - 0.001154*bill_depth_mm +0.004003*bill_length_mm
        ...
        .col-lg-11.mx-auto.d-flex.flex-wrap(titulo="Paso 5")
          .col-lg-8.pe-lg-4.order-2.order-lg-1
            ...
            .d-flex.pe-md-3.mb-3
              .tarjeta.px-4.py-2(style="background-color: #24135A;" data-aos="fade-left")
                p.text-white var_ratio = pca.explained_variance_ratio_ 
                  br                
